...
def crm_export_from_lead(*, lead: dict[str, Any], timeline: list[dict[str, Any]] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "pipeline": {
            ...
            "followup_strategy": lead.get("followup_strategy"),
            "qualification_priority": lead.get("qualification_priority"),
            "qualification_priority_reason": lead.get("qualification_priority_reason"),
        ...
        "commercial_context": {
            ...
            "uom": lead.get("uom"),
            "requested_items": lead.get("requested_items") if isinstance(lead.get("requested_items"), list) else [],
            "requested_item_count": lead.get("requested_item_count"),
            "requested_items_have_quantities": lead.get("requested_items_have_quantities"),
            "requested_items_need_uom_confirmation": lead.get("requested_items_need_uom_confirmation"),
            "requested_items_assumed_uom": lead.get("requested_items_assumed_uom"),
            "requested_items_uom_assumption_status": lead.get("requested_items_uom_assumption_status"),
